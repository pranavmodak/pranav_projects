# -*- coding: utf-8 -*-
"""
Created on Fri May 21 11:53:09 2021
...
try:
    ...
    if j=='Jarvis':
        while True:
            ...
            #screenImg = pygame.image.load("Images/img1.png")
            ...
            try:
                ...
                if userInput=='v':
                    ...
                    #if  'alarm ' in command:
                    #    SET_ALARM=int(input("Pls tell the time to set alarm, for example set alarm to 5:30 a.m"))
                    #    engine.say("Pls tell the time to set alarm, for example set alarm to 5:30 a.m.")
                    #    engine.runAndWait()
                    #    tt=SET_ALARM.replace("set alarm to","")#5:30 a.m.
                    #    tt=SET_ALARM.replace(".","")#5:30 am
                    #    tt=tt.upper()#5:30 AM
                    #    MyAlarm.alarm(tt)
